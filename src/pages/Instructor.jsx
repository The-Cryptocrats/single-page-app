        ...
        <div className="container">
          <div className="heading py-12 text-center w-2/3 m-auto md:w-full">
            ...
            <span className="text-[14px] mt-2 block">
              Skilline, a premier service under the eduNow umbrella, offers
              access to a diverse array of over 1000 online courses. Elevate
              your skill set, advance your career, and discover the path to
              becoming a certified online course instructor through our
              specialized training programs. At Skilline, we believe in
              unlocking your potential and providing a professional platform for
              continuous learning and career advancement. Empower yourself with
              Skilline – where excellence meets education.
            </span>
          </div>
